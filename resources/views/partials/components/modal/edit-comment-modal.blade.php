<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
    id="edit-comment-modal" tabindex="-1" aria-labelledby="edit-comment-modalTitle" aria-modal="true" role="dialog">
            ...
            <div class="modal-body relative p-4">
                <form action="" id="edit-form" method="POST">
                    ...
                    <div class="mb-4 w-full bg-gray-50 rounded-lg border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                        <div>
                            <input id="edit-user_comment" type="hidden" name="user_comment">
                            <trix-editor id="trix-editor-comment" input="edit-user_comment" class="dark:text-white"
                                placeholder="Ketik komentarmu disini..."></trix-editor>
                        </div>
                    </div>
            </div>
            <div
                class="modal-footer flex flex-shrink-0 flex-wrap items-center justify-end p-4 border-t border-gray-200 rounded-b-md">
                <button type="submit" id="edit-comment-btn"
