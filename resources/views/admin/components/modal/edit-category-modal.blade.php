<div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
    id="editCategoryModal" tabindex="-1" aria-labelledby="editCategoryModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable relative w-auto pointer-events-none">
        <div
            ...
            <div
                ...
                <h5 class="text-xl font-semibold leading-normal text-white" id="editCategoryModalLabel">
                    Create New Category
                </h5>
            </div>
                    ...
                    <div class="relative my-5">
                        <div>
                            ...
                            <input type="text" id="category_name" name="category_name"
                                class="edit-category-name bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
